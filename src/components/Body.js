...
const Body = () => {
  ...
  if(isOnline===false) return <h1>Looks like you are offline!! please check your interet connection</h1>
    ...
    <div className="body">
      <div className="flex  items-center">
        <div className="">
          ...
          />
          <button className="ml-3 mr-7 bg-green-500 rounded-lg px-2 py-1"
            onClick={() => {
